...
import { RefreshCw, Target, ChevronRight, Users, ArrowLeftRight, CreditCard, PiggyBank, Bell } from "lucide-react"
    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="px-6 pt-6 space-y-3">
        <div className="bg-white rounded-3xl overflow-hidden">
          ...
          <Link href="/konto/konto_gemeinsam" className="flex items-center gap-4 px-5 py-4 border-b border-gray-100">
          ...
          <Link href="/kreditkarten" className="flex items-center gap-4 px-5 py-4 border-b border-gray-100">
            ...
            <span className="text-sm font-semibold text-gray-900 flex-1">Kreditkarten</span>
            <ChevronRight className="w-4 h-4 text-gray-300" />
          </Link>
          <Link href="/abrechnung" className="flex items-center gap-4 px-5 py-4 border-b border-gray-100">
            <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ backgroundColor: "#f5922020" }}>
              <ArrowLeftRight className="w-4 h-4" style={{ color: "#f59220" }} />
            </div>
            <span className="text-sm font-semibold text-gray-900 flex-1">Abrechnung</span>
            <ChevronRight className="w-4 h-4 text-gray-300" />
          </Link>
          <Link href="/notifications" className="flex items-center gap-4 px-5 py-4">
            ...
            <span className="text-sm font-semibold text-gray-900 flex-1">Notifications</span>
            <ChevronRight className="w-4 h-4 text-gray-300" />
          </Link>
        </div>
