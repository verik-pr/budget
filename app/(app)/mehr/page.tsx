...
import { RefreshCw, Target, ChevronRight, Users, CreditCard, PiggyBank, Bell, Tags, Gift } from "lucide-react"
    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="stagger px-6 pt-6 space-y-3">
        <div className="bg-card border border-rule shadow-card rounded-3xl overflow-hidden">
          ...
          <Link href="/geschenkkarten" className="flex items-center gap-4 px-5 py-4 border-b border-rule/60">
            <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ backgroundColor: "#ec489920" }}>
              <Gift className="w-4 h-4" style={{ color: "#ec4899" }} />
            </div>
            <span className="text-sm font-semibold text-ink flex-1">Geschenkkarten</span>
            <ChevronRight className="w-4 h-4 text-faint" />
          </Link>
